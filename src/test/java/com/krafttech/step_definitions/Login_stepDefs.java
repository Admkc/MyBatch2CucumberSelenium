...
public class Login_stepDefs {
    ...
    public void theUserEntersAdemKOÇCredentials() {
        System.out.println("I enter Adem KOÇ email and password and click login button..");
    }


    @When("The user enters Efe credentials")
    public void theUserEntersEfeCredentials() {
        System.out.println("I enter efe email and password and click login button..");
    }
